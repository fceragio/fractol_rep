...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/09/12 17:04:31 by federico          #+#    #+#             */
/*   Updated: 2024/09/20 00:35:58 by federico         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void	explain_julia(void)
{
	...
	put_string("After generating a Julia, you can click on the screen to\n");
	put_string("change the value of the original x and y coordinates\n\n");
}

static void	explain_ship(void)
{
	put_string("BURNING SHIP SET\n");
	put_string("./fractol BurningShip\n");
	put_string("Please notice the capitals \'B\' & \'S\'\n\n");
}
